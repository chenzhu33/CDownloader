...
import com.carelife.cdownloader.cache.disc.impl.UnlimitedDiscCache;
import com.carelife.cdownloader.cache.disc.naming.FileNameGenerator;
import com.carelife.cdownloader.cache.memory.MemoryCacheAware;
import com.carelife.cdownloader.cache.memory.impl.FuzzyKeyMemoryCache;
...
import com.carelife.cdownloader.core.decode.ImageDecoder;
import com.carelife.cdownloader.core.download.ImageDownloader;
import com.carelife.cdownloader.core.download.NetworkDeniedImageDownloader;
import com.carelife.cdownloader.core.download.SlowNetworkImageDownloader;
import com.carelife.cdownloader.utils.L;

/**
 * Presents configuration for {@link CDownloader}
 * 
 ...
 */
public final class CDownloaderConfiguration {
	...
	private CDownloaderConfiguration(final Builder builder) {
	...
	/**
	 * Creates default configuration for {@link CDownloader} <br />
	 * <b>Default values:</b>
	 * <ul>
	 ...
	 * </ul>
	 * */
	public static CDownloaderConfiguration createDefault(Context context) {
		return new Builder(context).build();
	}

	/**
	 * Builder for {@link CDownloaderConfiguration}
	 * 
	 * @author Chen Zhuwei (czwcarelife[at]gmail[dot]com)
	 */
	public static class Builder {
		 ...
		 * {@link com.carelife.cdownloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.carelife.cdownloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.carelife.cdownloader.cache.disc.impl.TotalSizeLimitedDiscCache TotalSizeLimitedDiscCache}
		 ...
		 * By default: disc cache is unlimited.<br />
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.carelife.cdownloader.cache.disc.impl.FileCountLimitedDiscCache FileCountLimitedDiscCache}
		 * will be used as disc cache. You can use {@link #discCache(DiscCacheAware)} method for introduction your own
		 * implementation of {@link DiscCacheAware}
		 */
		 ...
		 * Default value -
		 * {@link com.carelife.cdownloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		 ...
		 * Default value -
		 * {@link com.carelife.cdownloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.carelife.cdownloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Default value - {@link com.carelife.cdownloader.cache.disc.impl.UnlimitedDiscCache
		 * UnlimitedDiscCache}. Cache directory is defined by
		 * {@link com.carelife.cdownloader.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * be used for every {@linkplain CDownloader#displayImage(String, android.widget.ImageView) image display call}
		...
		/** Enabled detail logging of {@link CDownloader} work */
		public Builder enableLogging() {
			this.loggingEnabled = true;
			return this;
		}

		/** Builds configured {@link CDownloaderConfiguration} object */
		public CDownloaderConfiguration build() {
			initEmptyFiledsWithDefaultValues();
			return new CDownloaderConfiguration(this);
		}
